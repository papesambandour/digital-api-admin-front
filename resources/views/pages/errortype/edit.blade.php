            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h4>Modifier type d'erreur</h4>
                            <span>Donne la possibilité de modifier un type d'erreur   </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-block">
                        <form method="POST" action="/error_type/{{$entity->id}}" onsubmit="document.getElementById('error_type_submit').setAttribute('disabled', 'disabled')">
                         @method('put')
                            @csrf
                            {{-- #############################################FILED ############################## --}}
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input required  value="{{$entity->code}}" name="code" id="code" type="text"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <textarea required  rows="5" name="regex" id="regex" type="text"
                                              class="form-control form-control-normal" placeholder="Regex">{{$entity->regex}}</textarea>
                                    @error('regex')
                                    <div  class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input required  value="{{$entity->index}}" name="index" id="index" type="tel"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <textarea rows="5"
                                        ...
                                        class="form-control form-control-normal" placeholder="Message">{{$entity->message}}</textarea>
                                    @error('message')
                                    <div  class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <select    name="sous_services_id" id="sous_services_id"
                                        ...
                                        @foreach($sousServices as $sousService)
                                            <option @if($entity->sous_services_id == $sousService->id) selected @endif value="{{$sousService->id}}">{{$sousService->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-3">
                                    <select required    name="is_critic" id="is_critic"
                                        ...
                                        @foreach(yesNonSelect() as $key => $value)
                                            <option @if($entity->is_critic == $value) selected @endif value="{{$value}}">{{$key}}</option>
                                        @endforeach
                                    </select>
                                    @error('is_critic')
                                    <div  class="invalid-feedback ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <select required    name="is_json" id="is_json"
                                            class="form-control form-control-normal" >
                                        @foreach(yesNonSelect() as $key => $value)
                                            <option @if($entity->is_json == $value) selected @endif value="{{$value}}">{{$key}}</option>
                                        @endforeach
                                    </select>
                                    @error('is_json')
                                    <div  class="invalid-feedback ">
