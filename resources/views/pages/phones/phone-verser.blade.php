            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h4>Versement pour le service provider <span style="color:green;font-weight: bold">#{{$phones->id  . '<=>' . $phones->number}} | {{$phones->sousServicesPhones[0]->sousService->name}} | {{$phones->service->name}}</span> </h4>
                            <span>Donne la possibility de verser un montant pour le service  <span class="currency">{{$phones->number}}   </span> </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
