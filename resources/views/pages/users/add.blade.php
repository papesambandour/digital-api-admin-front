                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>Donne la possibility d'ajouter un utilisateur   </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-block">
                        <form method="POST" action="/users" onsubmit="document.getElementById('submit_users').setAttribute('disabled', 'disabled')">

                  {{-- #############################################FILED ############################## --}}
                            <div class="form-group row">
                                <label for="f_name" class="col-sm-3 col-form-label">Prénom</label>
                                <div class="col-sm-3">
                                    <input required  value="{{old('f_name')}}" name="f_name" id="f_name" type="text"
                  ...
                  {{-- #############################################FILED ############################## --}}
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input required  value="{{old('l_name')}}" name="l_name" id="l_name" type="text"
                  ...
                  {{-- #############################################FILED ############################## --}}
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input required  value="{{old('phone')}}" name="phone" id="phone" type="tel"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <textarea
                                           ...
                                           class="form-control form-control-normal" placeholder="Adresse">{{old('address')}}</textarea>
                                    @error('address')
                                    <div  class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <select required   name="profils_id" id="address"
                                        ...
                                        <option @if(old('profils_id') == $profil->id) selected @endif value="{{$profil->id}}">{{$profil->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('profils_id')
                                    <div  class="invalid-feedback ">
